...
They allow pull request authors and reviewers to "Preview" the MCM RIS Viewer as if
...
The DEPLOY workflow deploys the MCM RIS Viewer when changes are merged to master.
